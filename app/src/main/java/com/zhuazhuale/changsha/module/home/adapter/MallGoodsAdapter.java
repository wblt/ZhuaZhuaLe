...
public class MallGoodsAdapter extends RecyclerBaseAdapter<DeviceGoodsBean.RowsBean> {

    private OnHomeClickListener clickListener;

    public MallGoodsAdapter(@NonNull Context context, @NonNull List<DeviceGoodsBean.RowsBean> mDataList) {
...
//                tv_status.setText("更换中");
        ...
        tv_device_price.setText(rowsBean.getF_Price() + " 元/个");
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.item_mallgoods, parent, false);
