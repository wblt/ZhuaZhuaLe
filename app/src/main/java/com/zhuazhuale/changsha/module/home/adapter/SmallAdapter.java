...
public class SmallAdapter extends RecyclerBaseAdapter<DeviceGoodsBean.RowsBean> {

    private OnHomeClickListener clickListener;

    public SmallAdapter(@NonNull Context context, @NonNull List<DeviceGoodsBean.RowsBean> mDataList) {
...
//                tv_status.setText("更换中");
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.item_small, parent, false);
